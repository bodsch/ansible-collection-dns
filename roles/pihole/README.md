...
pihole_ipv4_address: "{{ ansible_default_ipv4.address }}/24"
pihole_ipv6_address: ""
...
# Web interface
pihole_web_port: 80
pihole_admin_password: "fooo-bar"  # Leer lassen für zufälliges Passwort

# Custom lists (optional)
pihole_custom_blocklists: []
  ...
  # - "https://raw.githubusercontent.com/hoshsadiq/adblock-nocoin-list/master/hosts.txt"  # Krypto-Mining Blocker
  # - "https://raw.githubusercontent.com/Perflyst/PiHoleBlocklist/master/SmartTV-AGH.txt"  # Smart TV Telemetrie
